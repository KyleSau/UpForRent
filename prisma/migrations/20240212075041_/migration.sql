...
-- CreateIndex
CREATE UNIQUE INDEX "Listing_slug_siteId_key" ON "Listing"("slug", "siteId");
...
-- AddForeignKey
ALTER TABLE "Thread" ADD CONSTRAINT "Thread_subCategoryId_fkey" FOREIGN KEY ("subCategoryId") REFERENCES "SubCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;
